About api2db-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/api2db-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12957&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/api2db-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `api2db` can be installed with `conda`:
...
```
mamba install api2db
```

It is possible to list all of the versions of `api2db` available on your platform with `conda`:
...
```
mamba search api2db --channel conda-forge
```
...
mamba repoquery search api2db --channel conda-forge

# List packages depending on `api2db`:
mamba repoquery whoneeds api2db --channel conda-forge

# List dependencies of `api2db`:
mamba repoquery depends api2db --channel conda-forge
```
